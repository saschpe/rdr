...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feeds_subscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feeds.Feed'])),
            ('custom_feed_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True)),
        ))
        db.send_create_signal('feeds', ['Subscription'])

        # Adding unique constraint on 'Subscription', fields ['user', 'feed']
        db.create_unique('feeds_subscription', ['user_id', 'feed_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Subscription', fields ['user', 'feed']
        db.delete_unique('feeds_subscription', ['user_id', 'feed_id'])

        # Deleting model 'Subscription'
        db.delete_table('feeds_subscription')
    ...
    models = {
        ...
        'feeds.subscription': {
            ...
            'custom_feed_title': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['feeds.Feed']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
