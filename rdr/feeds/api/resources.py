...
class WebsiteResource(ModelResource):
    feed_set = fields.ToManyField('rdr.feeds.api.resources.FeedResource', 'feed_set')
...
class FeedResource(ModelResource):
    ...
    entry_set = fields.ToManyField('rdr.feeds.api.resources.EntryResource', 'entry_set')
    subscriber_set = fields.ToManyField('rdr.feeds.api.resources.VisistedResource', 'subscriber_set')
...
class EntryResource(ModelResource):
    ...
    visitor_set = fields.ToManyField('rdr.feeds.api.resources.VisistedResource', 'visitor_set')
