...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.custom_feed_title'
        db.alter_column('feeds_subscription', 'custom_feed_title', self.gf('django.db.models.fields.CharField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Subscription.custom_feed_title'
        db.alter_column('feeds_subscription', 'custom_feed_title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
