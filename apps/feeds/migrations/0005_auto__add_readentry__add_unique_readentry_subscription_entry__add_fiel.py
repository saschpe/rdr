...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.unread_entries'
        db.add_column('feeds_subscription', 'unread_entries', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Subscription.unread_entries'
        db.delete_column('feeds_subscription', 'unread_entries')
